import{o as c,a as d}from"../chunks/chunk-BoeVIwFW.js";import{j as e}from"../chunks/chunk-CcgYQrw7.js";import{L as n}from"../chunks/chunk-banPbZ89.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as o}from"../chunks/chunk-CiYkPOqI.js";/* empty css                      *//* empty css                      *//* empty css                      */const h=[{pageSectionId:"example",pageSectionLevel:2,pageSectionTitle:"Example"},{pageSectionId:"avoid-pagecontext-json-requests",pageSectionLevel:2,pageSectionTitle:"Avoid `pageContext.json` requests"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function t(l){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...o(),...l.components},{ChoiceGroup:r,CustomSelectsContainer:a}=s;return r||i("ChoiceGroup"),a||i("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Upon ",e.jsx(n,{href:"/client-routing",children:"client-side navigation"}),`,
...
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsxs(s.p,{children:["If you have a ",e.jsx(n,{href:"/integration#server-manual-integration",children:"custom server integration"})," (i.e. you don't use ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server.js"})}),"), make sure the ",e.jsx(s.code,{children:"pageContextInit"})," you pass to ",e.jsx(n,{href:"/renderPage",children:e.jsx(s.code,{children:"renderPage()"})})," doesn't contain a property included in ",e.jsx(n,{href:"/passToClient",children:e.jsx(s.code,{children:"passToClient"})}),"."]}),`
