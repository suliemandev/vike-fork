import{o as p,a as x}from"../chunks/chunk-BoeVIwFW.js";import{j as e,l as c}from"../chunks/chunk-CcgYQrw7.js";import{L as l}from"../chunks/chunk-banPbZ89.js";/* empty css                      */import{W as t}from"../chunks/chunk-CPQJm-WO.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as h}from"../chunks/chunk-CiYkPOqI.js";import{V as i}from"../chunks/chunk-CEsOP1Rp.js";import{G as j}from"../chunks/chunk-C5KhkBty.js";/* empty css                      */import"../chunks/chunk-D3BeG_Yi.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const y=[{pageSectionId:"installation",pageSectionLevel:2,pageSectionTitle:"Installation"},{pageSectionId:"vue",pageSectionLevel:3,pageSectionTitle:"Vue"},{pageSectionId:"react",pageSectionLevel:3,pageSectionTitle:"React"},{pageSectionId:"metadata",pageSectionLevel:2,pageSectionTitle:"Metadata"},{pageSectionId:"global-metadata",pageSectionLevel:4,pageSectionTitle:"Global metadata"},{pageSectionId:"page-metadata",pageSectionLevel:4,pageSectionTitle:"Page metadata"},{pageSectionId:"with-a-metadata-js-file",pageSectionLevel:3,pageSectionTitle:"With a `metadata.js` file"},{pageSectionId:"with-a-custom-setting-eager",pageSectionLevel:3,pageSectionTitle:"With a custom setting (eager)"},{pageSectionId:"with-a-custom-setting",pageSectionLevel:3,pageSectionTitle:"With a custom setting"},{pageSectionId:"with-frontmatter",pageSectionLevel:3,pageSectionTitle:"With frontmatter"},{pageSectionId:"examples",pageSectionLevel:2,pageSectionTitle:"Examples"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(r){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...h(),...r.components},{ChoiceGroup:n,CustomSelectsContainer:a}=s;return n||d("ChoiceGroup"),a||d("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx("h2",{id:"installation",children:"Installation"}),`
...
`,e.jsx(c,{path:"/examples/vue-full/vite.config.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(c,{path:"/examples/vue-full/pages/markdown/+Page.md"}),`
`]}),`
`]}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
`,e.jsx(c,{path:"/examples/react-full/vite.config.ts"}),`
`]}),`
`,e.jsxs(s.li,{children:[`
`,e.jsx(c,{path:"/examples/react-full/pages/markdown/+Page.mdx"}),`
`]}),`
`]}),`
...
`]}),`
`]}),`
`,e.jsx(t,{children:e.jsxs(s.p,{children:["You may be tempted to use ",e.jsx(s.a,{href:"https://vitejs.dev/guide/features.html#glob-import",children:e.jsx(s.code,{children:"import.meta.glob()"})})," to retrieve metadata defined inside all ",e.jsx(s.code,{children:"+Page.md"})," files, but we discourage this approach: loading all ",e.jsx(s.code,{children:"+Page.md"})," files at once ",e.jsx(i,{}),"."]})}),`
...
`,e.jsx(t,{children:e.jsxs(s.p,{children:["We discourage using frontmatter for defining ",e.jsx(l,{href:"#global-metadata",children:"global metadata"}),", because loading all ",e.jsx(s.code,{children:"+Page.md"})," files at once ",e.jsx(i,{}),"."]})}),`
...
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(j,{repo:"blankeos/gittydocs"})," - Documentation builder."]}),`
`]}),`
...
`]}),`
`]})]})}function g(r={}){const{wrapper:s}={...h(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(o,{...r})}):o(r)}function d(r,s){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const u=Object.freeze(Object.defineProperty({__proto__:null,default:g,pageSectionsExport:y},Symbol.toStringTag,{value:"Module"})),z={hasServerOnlyHook:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!1}},isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},guardEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:x}},onCreatePageContext:{type:"cumulative",definedAtData:[{filePathToShowToUser:"@brillout/docpress/renderer/onCreatePageContext",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"pointer-import",value:p}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/markdown/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:u}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}}};export{z as configValuesSerialized};
