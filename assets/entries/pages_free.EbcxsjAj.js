...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["In general, we consider an organization to have limited financial resources if it has ",e.jsx(n.strong,{children:"fewer than 20 employees"}),", though organizations in ",e.jsx(n.strong,{children:"lower-income countries can exceed this threshold"}),"."]}),`
`,e.jsx(n.p,{children:"You can still apply if you have more than 20 employees — financial constraints matter more than headcount. However, apply only if you genuinely cannot afford a license, not simply to reduce costs."}),`
`]}),`
