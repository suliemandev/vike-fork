import{o as t,a as d}from"../chunks/chunk-BoeVIwFW.js";import{j as e}from"../chunks/chunk-CcgYQrw7.js";import{L as s}from"../chunks/chunk-banPbZ89.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as i}from"../chunks/chunk-CiYkPOqI.js";import{U as h}from"../chunks/chunk-ALu-2GZu.js";/* empty css                      */import"../chunks/chunk-D3BeG_Yi.js";import{C as p}from"../chunks/chunk-DIFpMxVT.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const x=[{pageSectionId:"onbeforerender-vs-data",pageSectionLevel:2,pageSectionTitle:"`onBeforeRender()` VS `data()`"},{pageSectionId:"environment",pageSectionLevel:2,pageSectionTitle:"Environment"},{pageSectionId:"onbeforerender-meta",pageSectionLevel:2,pageSectionTitle:"`onBeforeRender()` + `meta`"},{pageSectionId:"override",pageSectionLevel:2,pageSectionTitle:"Override"},{pageSectionId:"advanced-example",pageSectionLevel:2,pageSectionTitle:"Advanced example"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function c(r){const n={blockquote:"blockquote",code:"code",div:"div",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...i(),...r.components},{ChoiceGroup:l,CustomSelectsContainer:a}=n;return l||o("ChoiceGroup"),a||o("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx(p,{env:e.jsxs(e.Fragment,{children:["server (",e.jsx(s,{href:"#environment",children:"configurable"}),")"]}),cumulative:!1}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["If you use a custom renderer instead of ",e.jsx(h,{name:!0,noLink:!0}),", then you can modify your ",e.jsx(n.code,{children:"onRenderHtml()"}),"/",e.jsx(n.code,{children:"onRenderClient()"})," hooks instead of doing the following."]}),`
`]}),`
