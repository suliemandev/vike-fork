import{o as d,a as c}from"../chunks/chunk-BoeVIwFW.js";import{j as e}from"../chunks/chunk-CcgYQrw7.js";import{L as n}from"../chunks/chunk-banPbZ89.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as t}from"../chunks/chunk-CiYkPOqI.js";/* empty css                      *//* empty css                      *//* empty css                      */const h=[{pageSectionId:"vite-config-js",pageSectionLevel:2,pageSectionTitle:"`vite.config.js`"},{pageSectionId:"tsconfig-json",pageSectionLevel:2,pageSectionTitle:"`tsconfig.json`"},{pageSectionId:"package-json",pageSectionLevel:2,pageSectionTitle:"`package.json`"},{pageSectionId:"config-files",pageSectionLevel:2,pageSectionTitle:"Config files"}];function a(i){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",em:"em",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...t(),...i.components},{ChoiceGroup:l,CustomSelectsContainer:r}=s;return l||o("ChoiceGroup"),r||o("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx(s.p,{children:"Instead of using relative import paths, which can be cumbersome, you can use path aliases. For example:"}),`
...
`]}),`
`]}),`
`,e.jsxs(s.p,{children:["If you use a custom server integration (",e.jsxs(s.strong,{children:["you don't use ",e.jsx(s.code,{children:"+server.js"})]}),"), also define them at:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[`
...
`,e.jsxs(s.li,{children:["Your server code if you use ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server.js"})}),"."]}),`
`]}),`
...
`,e.jsxs(s.p,{children:["If you use a JavaScript server, with a ",e.jsx(n,{href:"/integration#server-manual-integration",children:"custom integration"})," instead of using ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server.js"})}),", then also define your path aliases at:"]}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server.js"})}),", all your server code is transpiled by Vite. Defining path aliases at ",e.jsx(s.code,{children:"vite.config.js"})," is enough because Vite already resolves all path aliases and Node.js doesn't see any path alias."]}),`
`,e.jsxs(s.p,{children:["If you don't use ",e.jsx(s.code,{children:"+server.js"}),", your server code isn't processed by ",e.jsx(s.a,{href:"https://vite.dev",children:"Vite"})," out of the box. Instead, Node.js directly executes your server code and, therefore, you must configure Node.js to resolve your path aliases. See also: ",e.jsx(s.a,{href:"https://github.com/vikejs/vike/issues/562",children:"#562 - Transpile server code"}),"."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
