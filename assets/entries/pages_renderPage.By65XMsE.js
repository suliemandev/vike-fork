import{o as t,a as d}from"../chunks/chunk-BoeVIwFW.js";import{j as e}from"../chunks/chunk-CcgYQrw7.js";import{L as n}from"../chunks/chunk-banPbZ89.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{u as c}from"../chunks/chunk-CiYkPOqI.js";import{M as p}from"../chunks/chunk-B6Kzj4At.js";/* empty css                      */import"../chunks/chunk-D3BeG_Yi.js";import{C as h}from"../chunks/chunk-DIFpMxVT.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-ALu-2GZu.js";/* empty css                      */const x=[{pageSectionId:"usage",pageSectionLevel:2,pageSectionTitle:"Usage"},{pageSectionId:"optional",pageSectionLevel:2,pageSectionTitle:"Optional"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function o(l){const s={a:"a",blockquote:"blockquote",code:"code",div:"div",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...c(),...l.components},{ChoiceGroup:r,CustomSelectsContainer:a}=s;return r||i("ChoiceGroup"),a||i("CustomSelectsContainer"),e.jsxs(e.Fragment,{children:[e.jsx(h,{env:"server",global:null}),`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"renderPage()"})," function enables you to embed Vike into any server, see ",e.jsx(n,{href:"/integration#server-manual-integration",doNotInferSectionTitle:!0,noBreadcrumb:!0}),"."]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["We generally recommend using ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server"})})," instead of ",e.jsx(s.code,{children:"renderPage()"}),"."]}),`
`,e.jsxs(s.p,{children:["If you use ",e.jsx(n,{href:"/server",children:e.jsx(s.code,{children:"+server"})})," then you don't need to call ",e.jsx(s.code,{children:"renderPage()"})," yourself (",e.jsx(s.code,{children:"+server"})," already calls it)."]}),`
`,e.jsxs(s.p,{children:["We recommend using ",e.jsx(s.code,{children:"renderPage()"})," instead of ",e.jsx(s.code,{children:"+server"})," only if you have a clear reason not to use ",e.jsx(s.code,{children:"+server"}),"."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
...
`,e.jsx(a,{children:e.jsxs(r,{choiceGroup:{name:"codeLang",choices:["JavaScript","TypeScript"],default:"JavaScript",emptyChoices:[],hidden:!1,lvl:0},children:[e.jsx(s.div,{"data-choice-value":"JavaScript",className:"choice",children:e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// server/index.js"})}),`
...
`,e.jsxs(s.p,{children:["If you ",e.jsx(n,{text:"pre-render",href:"/pre-rendering"})," all your pages then ",e.jsx(s.code,{children:"renderPage()"})," isn't needed, because:"]}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.li,{children:["Upon pre-rendering (",e.jsx(s.code,{children:"$ vike build"}),"/",e.jsx(s.code,{children:"$ vike prerender"}),"), Vike renders your pages without server."]}),`
`]}),`
`,e.jsxs(s.p,{children:["But, if you use Server-Side Rendering (SSR), then you need a production server and ",e.jsx(s.code,{children:"renderPage()"})," is required. See ",e.jsx(n,{href:"/pre-rendering"}),"."]}),`
